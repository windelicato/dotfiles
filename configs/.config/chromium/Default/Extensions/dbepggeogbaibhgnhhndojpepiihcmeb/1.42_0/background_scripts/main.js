...
(function() {
  var BackgroundCommands, checkKeyQueue, compareVersions, completers, completionSources, copyToClipboard, currentVersion, fetchFileContents, filterCompleter, focusedFrame, framesForTab, generateCompletionKeys, getActualKeyStrokeLength, getCompletionKeysRequest, getCurrFrameIndex, getCurrentTabUrl, getCurrentTimeInSeconds, handleFrameFocused, handleKeyDown, handleSettings, handleUpdateScrollPosition, helpDialogHtmlForCommandGroup, isEnabledForUrl, keyQueue, namedKeyRegex, openOptionsPageInNewTab, openTabs, openUrlInCurrentTab, openUrlInNewTab, populateSingleKeyCommands, populateValidFirstKeys, portHandlers, refreshCompleter, registerFrame, repeatFunction, root, saveHelpDialogSettings, selectSpecificTab, selectTab, selectionChangedHandlers, sendRequestHandlers, sendRequestToAllTabs, shouldShowUpgradeMessage, singleKeyCommands, splitKeyIntoFirstAndSecond, splitKeyQueue, tabLoadedHandlers, tabQueue, updateActiveState, updateOpenTabs, updatePositionsAndWindowsForAllTabsInWindow, updateScrollPosition, upgradeNotificationClosed, validFirstKeys;
  ...
  chrome.extension.onConnect.addListener(function(port, name) {
    ...
    if (port.name === "domReady" && senderTabId !== null) {
      ...
      if (shouldShowUpgradeMessage()) {
        chrome.tabs.sendRequest(senderTabId, {
  ...
  fetchFileContents = function(extensionFileName) {
    ...
    req.open("GET", chrome.extension.getURL(extensionFileName), false);
    req.send();
  ...
  filterCompleter = function(args, port) {
    var queryTerms;
    queryTerms = args.query === "" ? [] : args.query.split(" ");
      ...
      return chrome.windows.getCurrent(function(window) {
        ...
        return chrome.tabs.create({
          ...
          tabLoadedHandlers[tab.id] = function() {
            var scrollPort;
            return scrollPort = chrome.tabs.sendRequest(tab.id, {
  ...
  updateScrollPosition = function(tab, scrollX, scrollY) {
    ...
    return openTabs[tab.id].scrollY = scrollY;
  };
      ...
      for (_i = 0, _len = windows.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
            tab = _ref[_j];
            _results1.push(chrome.tabs.sendRequest(tab.id, args, null));
          }
          return _results1;
        })());
      }
  ...
  window.runTests = function() {
    return open(chrome.extension.getURL('tests/dom_tests/dom_tests.html'));
  };
